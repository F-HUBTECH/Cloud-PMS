...
export function Dashboard() {
    const stats = [
        { title: 'Total Rooms', value: '120', subtext: '85 Occupied', icon: DoorOpen, color: 'bg-indigo-500', bg: 'bg-indigo-50' },
        { title: 'Check-ins Today', value: '12', subtext: '5 pending', icon: Users, color: 'bg-emerald-500', bg: 'bg-emerald-50' },
        { title: 'Check-outs Today', value: '8', subtext: '2 completed', icon: Calendar, color: 'bg-amber-500', bg: 'bg-amber-50' },
        { title: 'Revenue Today', value: '$8,450', subtext: '+12% from yesterday', icon: DollarSign, color: 'bg-rose-500', bg: 'bg-rose-50' },
    ];
    ...
    return (
        <div className="space-y-6">
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            {roomStatus.map((room) => (
                                <div
                                    key={room.status}
                                    className="flex items-center justify-between rounded-lg bg-accent/10 p-3 transition-all hover:shadow-md"
                                >
            ...
            {/* 7-Day Occupancy Trend (Recharts) */}
            <Card className="shadow-lg">
                <CardHeader>
                ...
                <CardContent>
                    <div className="h-64 w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={occupancyData} margin={{ top: 8, right: 8, left: 0, bottom: 8 }}>
